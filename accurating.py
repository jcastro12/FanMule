...
jax.config.update("jax_numpy_rank_promotion", "raise")  # bug prevention
jax.config.update("jax_enable_x64", True)  # better model accuracy


def win_prob(rating, opp_rating):
    """Probability of win for given ratings."""
    return 1.0 / (1.0 + 10**((opp_rating-rating)/480.0))
